...
export const sampleTickers = [
  ...
  { ticker: 'MSFT',   name: '마이크로소프트', current_price: 414200, today_rate:  1.48 },
];
...
export const samplePredictionResults = {
  kospi: [
    ...
    { ticker: '005380', name: '현대차',     signal: 'BUY',  buy_probability: 0.68, sell_probability: 0.32 },
  ],
  kosdaq: [
    ...
    { ticker: '041510', name: 'SM엔터테인먼트',  signal: 'HOLD', buy_probability: 0.55, sell_probability: 0.45 },
  ],
  nasdaq: [
    ...
    { ticker: 'AMZN', name: '아마존',   signal: 'BUY',  buy_probability: 0.71, sell_probability: 0.29 },
  ],
  nyse: [
    ...
    { ticker: 'JPM', name: 'JP모건',   signal: 'HOLD', buy_probability: 0.58, sell_probability: 0.42 },
  ],
};
