 ...
 *
 * 테이블 컬럼:
 * id, user_id, ticker, strategy, is_active, execution_time,
 * buy_condition, sell_condition, amount, created_at, updated_at
 */
...
export async function fetchSettings() {
  try {
    const { data, error } = await supabase
      .from(TABLE_SETTINGS)
      .select('id, user_id, ticker, strategy, is_active, execution_time, buy_condition, sell_condition, amount, created_at, updated_at')
