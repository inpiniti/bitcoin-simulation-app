...
const colorMap = {
  blue:   { fill: tdsColors.blue500,   weak: tdsColors.blue50,   text: tdsColors.blue600 },
...
export function Badge({ children, variant = 'fill', color = 'blue', size = 'small' }) {
  ...
  return (
    <View style={[{
      ...
      <Text style={{ color: textColor, fontSize: s.fontSize, fontWeight: '600' }}>
        {children}
      </Text>
    </View>
  );
